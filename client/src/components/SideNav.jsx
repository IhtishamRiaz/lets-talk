...
import { BsChatSquareDotsFill, BsPersonFillExclamation, BsPeopleFill } from "react-icons/bs";
...
const SideNav = () => {
   ...
   const items = [
      ...
      { text: 'Friend Requests', icon: BsPersonFillExclamation, href: '/friend-requests' },
...
export const SidebarItem = ({ icon: Icon, text, href }) => {
   ...
   return (
      <Link to={href}>
         <li
            className={
               cn(`group relative flex items-center p-3 my-1 font-medium rounded-md cursor-pointer`,
         ...
         >
            ...
            {/* Tool Tip */}
            <div
               className='w-max absolute invisible px-2 py-1 ml-6 text-sm transition-all -translate-x-3 rounded-md left-full bg-primary-100 text-primary-800 opacity-20 group-hover:visible group-hover:opacity-100 group-hover:translate-x-0'
            >
               {text}
            </div>
         </li>
